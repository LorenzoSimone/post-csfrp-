...
if (empty($_SESSION['tokened'])) {
    $_SESSION['tokened'] = bin2hex(random_bytes(32));
}

$token = $_SESSION['token'];
$tokened = $_SESSION['tokened'];
?>
			  ...
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					...
					<input type="hidden" id="tokened" name="tokened" value="<?php echo $tokened; ?>" />
